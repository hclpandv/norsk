...
| ø | `/ø/` is an `/e/` with rounded lips. The tongue in the same position as when you say /e/, <br> and your lips should be rounded. The opening between the lips should be too big to whistle. <br> Make sure to push your tongue forward as for the /e/. If tongue slides back, you will end up with an /å/|
